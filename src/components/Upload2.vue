<template>
  <div>
    <el-container>
      <!--###################HEADER##################-->
      <el-header>
        <el-button @click="isOption = !isOption">Options</el-button>
        <h1>Full Example</h1>
      </el-header>
      <!--####################MAIN###################-->
      <el-main>
            ...
            <td>
              <div>
                ...
                <div>
                  ...
                  <div></div>
                  <a href="#" @click.prevent="$refs.upload.remove(file)">Remove</a>
                </div>
              </div>
            </td>
          </tr>
      ...
      <div>
        ...
        <div>
          ...
          <div>
            ...
            <a href="#" @click="onAddFolader">Add folder</a>
            <a href="#" @click.prevent="addData.show = true">Add data</a>
          </div>
        </div>
        <button type="button" v-if="!$refs.upload || !$refs.upload.active"
    ...
    <div v-show="isOption">
      <div>
        ...
        <input type="text" id="accept" v-model="accept">
        <small>Allow upload mime type</small>
      </div>
      <div>
      ...
      <div class="form-group">
        ...
        <small class="form-text text-muted">After the shutdown, use the POST method to upload
        </small>
      </div>
      <div class="form-group">
        <label for="thread">Thread:</label>
        <input type="number" max="5" min="1" id="thread" class="form-control"
               v-model.number="thread">
        <small class="form-text text-muted">Also upload the number of files at the same time (number
          of threads)
        </small>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="number" min="0" id="autoCompress" class="form-control"
               v-model.number="autoCompress">
        <small class="form-text text-muted" v-if="autoCompress > 0">More than {{autoCompress |
          formatSize}} files are automatically compressed
        </small>
      ...
      <div class="form-group">
        <div class="form-check">
          <label class="form-check-label">
            <input type="checkbox" id="drop-directory" class="form-check-input"
                   v-model="dropDirectory"> Drop directory
          </label>
        </div>
    ...
    <div :class="{modal: true, fade: true, show: addData.show}" id="modal-add-data" tabindex="-1"
         role="dialog">
    ...
    <div :class="{modal: true, fade: true, show: editFile.show}" id="modal-edit-file" tabindex="-1"
         role="dialog">
